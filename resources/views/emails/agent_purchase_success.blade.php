        ...
        <tr>
            <td class="content">
                ...
                <table>
                    <tr>
                        <th>Name</th>
                        <td>{{ $propertyPurchase->customer->first_name }} {{ $propertyPurchase->customer->last_name }}</td>
                    </tr>
                    <tr>
                        <th>Email</th>
                        <td>{{ $propertyPurchase->customer->email }}</td>
                    </tr>
                    <tr>
                        <th>Phone</th>
                        <td>{{ $propertyPurchase->customer->phone }}</td>
                    </tr>
                </table>
