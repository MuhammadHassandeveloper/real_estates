            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card" id="agentList">
                        <div class="card-body">
                            <form action="{{ route('agency.store_agent') }}" method="POST" enctype="multipart/form-data" id="propertyForm">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="zip_code" name="zip_code" class="form-control" placeholder="Enter zip code" value="{{ old('zip_code') }}" required>
                                                @error('zip_code')
                                                <span class="text-danger error" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-lg-12  col-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="bio" name="bio" class="form-control" rows="3" placeholder="Enter bio">{{ old('bio') }}</textarea>
                                                @error('bio')
                                                <span class="text-danger error" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
