...
@section('content')
    @php
        ...
        $missingFields = Helpers::checkAgencyProfileCompletion(Sentinel::getUser()->id);
    @endphp
            <!-- Start Page-content -->
                ...
                @if(!empty($missingFields))
                    <div class="col-xl-12 mb-3 mt-3 p-4">
                        ...
                        <div class="alert alert-warning alert-dismissible alert-label-icon label-arrow fade show"
                            ...
                            <strong>Warning</strong> - Your profile is incomplete. Please update the following
                            information to ensure public visibility and the ability to list properties for sale.
                            Incomplete profiles may affect your visibility to potential clients and limit your property
