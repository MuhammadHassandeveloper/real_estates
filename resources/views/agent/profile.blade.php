                                    ...
                                    <div class="card overflow-hidden">
                                        <div class="card-body pt-0 mt-5">
                                            <div class="text-center">
                                                <div class="mt-5">
                                                    @php use Cartalyst\Sentinel\Laravel\Facades\Sentinel; @endphp
                                                    <h5>{{ Sentinel::getUser()->first_name .' '. Sentinel::getUser()->last_name }}
                                                        <i class="bi bi-patch-check-fill align-baseline text-info ms-1"></i></h5>
                                        ...
                                        <div class="card-body border-top">
                                            <div class="d-flex align-items-center mb-4">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <a href="javascript:void(0);" class="badge bg-info-subtle text-info fs-12">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-2 mb-4">
                                        <ul class="nav nav-pills arrow-navtabs nav-secondary gap-2 flex-grow-1 order-2 order-lg-1" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link" data-bs-toggle="tab" href="#personalDetails" role="tab" aria-selected="false" tabindex="-1">
                                                    Personal Details
                                                </a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#changePassword" role="tab" aria-selected="true">
                                                    Changes Password
                                                </a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                        ...
                                        <div class="flex-shrink-0 ms-auto order-1 order-lg-2">
                                            <a href="pages-profile-settings.html" class="btn btn-secondary"><i class="bi bi-pencil-square align-baseline me-1"></i> Edit Profile</a>
                                        </div>
                                    </div>
                                    <div class="card">
